	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a	><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="/content" class=""><i class="lnr lnr-inbox"></i> <span>Content</span></a></li>
                        <li><a href="/guestbook" class=""><i class="lnr lnr-user"></i> <span>Guest user</span></a></li>
						<li><a href="/feedback" class="active"><i class="lnr lnr-thumbs-up"></i> <span>Feedback</span></a></li>
